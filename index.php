...
div.m10-workscheme .block.ico-3{
	background:url("images/ico-m10-workscheme-hom.png") no-repeat 23px 10px;
	background-size:auto 102px;
}
div#wrapper{
...
<div class="tabs-items" style="background-color:white;">
<p class="label" style="font-size:34px;margin-top:25px;">Уборка квартир, домов и коттеджей в Астане -
от профессиональных мастеров!</p>
<div class="block ico-1">
<span class="num">1</span>
<p>Закажите уборку. Расскажите,
где живете и что нужно сделать</p>
</div>

<div class="block ico-2">
<span class="num">2</span>
<p>Дождитесь клинера или оставьте
ключ, исполнитель придет со всем необходимым</p>
</div><div class="block ico-3">
<span class="num">3</span>
<p>Платите за результат и наслаждайтесь чистой квартирой!</p>
</div><a href="order.php"><input type="submit" value="заказать уборку"  class="btn t1 next" style="margin-top:20px;margin-bottom:-10px;"></a></div>
<!--lal-->
</div>
</div>
</div>
